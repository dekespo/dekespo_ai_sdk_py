...
class RectangleNeighboursTest(unittest.TestCase):
    ...
    def test_availableRectangleTwoBlocks(self):
        ...
        pos2 = Dim2D(1, 2)
        availablePoses = getAvailableNeighbours2D_rectangle(map, blockingPositions, getNeighbours2D_rectangle_4Sides, pos2)
        ...
        pos3 = Dim2D(2, 1)
        availablePoses = getAvailableNeighbours2D_rectangle(map, blockingPositions, getNeighbours2D_rectangle_8Sides, pos3)
    ...
    def test_availableRectangleEmptyMap(self):
        ...
        self.assertTrue(Dim2D(1, 0) in availablePoses)
        availablePoses = getAvailableNeighbours2D_rectangle(map, blockingPositions, getNeighbours2D_rectangle_8Sides, pos1)
